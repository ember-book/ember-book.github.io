...
(function($) {
  ...
  $(document).ready(function() {
    ...
    $(".email-button").click(function(e) {
      ...
      var url =
        "https://emberjs-email-sender.herokuapp.com/handle_email?email=" +
        email +
        "&from_site=emberjs-book";
    ...
    menuItems.click(function(e) {
      var hrefVal = $(this).attr("href"),
        offsetTop =
          hrefVal === "#" ? 0 : $(hrefVal).offset().top - topMenu.outerHeight();
      ...
      $("html, body")
        .stop()
        .animate({ scrollTop: offsetTop }, 800);
      ...
      var fromTop = $(this).scrollTop() + topMenuHeight,
        ...
        itemsScrolled = scrolledItems.map(function() {
          if ($(this).offset().top - 1 < fromTop)
            // -1 so that menuItem detects using click event
            return this;
        });
